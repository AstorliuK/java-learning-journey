...
public class Clazz {
    ...
    public Clazz(String major, String grade) {
        ...
        students[1] = new Student("002","红红",23,"女");
        students[2] = new Student("003","小刚",23,"男");
        students[3] = new Student("004","小张",23,"男");
        students[4] = new Student("005","李李",23,"女");
        studentIndex = 5;
        /*
         *
         */
    ...
    public void addStudent(Student student) {
        ...
        //检查时更改的bug，在添加时忘了使用isFull检查数组是否已满了
    ...
    public void printClazzInfo() {
        ...
        System.out.println(Menu.classTeacher.showInfo());
        for (int i = 0; i < studentIndex; i++) {
